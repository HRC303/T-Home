...
class Terkey:
  ...
  def about(self):
    ...
    * Telegram  : {a}https://bit.ly/2VDRZHD{c}
    * Facebook  : {a}https://bit.ly/3AYn8pb{c}
    * Instagram : {a}https://bit.ly/3hCkH41{c}
    * Blog      : {a}https://bit.ly/3r5n16I{c}
    * Youtube   : {a}https://bit.ly/3kglnhk{c}

    And if you want to give me some money, you can visit
    {a}https://bit.ly/3r5n16I{c}
